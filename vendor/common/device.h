...
#define MODULE_SPEAKER_ENABLE    1
...
#if (USB_SPEAKER_48K_COMPACT)
#define SPEAKER_RESOLUTION_BIT    16
#define SPEAKER_SAMPLE_RATE        16000
#define SPEAKER_CHANNLE_COUNT    1
#else
#define SPEAKER_RESOLUTION_BIT    16
#define SPEAKER_SAMPLE_RATE        32000
#define SPEAKER_CHANNLE_COUNT    2
#endif
...
#define PM_ACTIVE_SUSPEND_WAKEUP_TIME      50         // in ms  // longer time,  the battery may more stable
#define PM_ENTER_DEEPSLEEP_TIME            10000    //    600        // in MS
...
#define GSENSOR_MMA865X_ENABLE        1
#define GYRO_L3G_ENBALE                1
#define GYRO_MPU6050_ENBALE            0
#define MOUSE_SENSOR_A350            0
/////////////////// set default   ////////////////

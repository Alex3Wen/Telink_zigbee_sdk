...
#define MODULE_DMIC_ENABLE        0
    ...
    #endif
    #ifndef MODULE_BUFM_ENABLE
    #define MODULE_BUFM_ENABLE        0
    #endif
    #ifndef MODULE_PRIQ_ENABLE
    #define MODULE_PRIQ_ENABLE        0
    #endif
#elif (APPLICATION_MAC_TEST)
    #ifndef MODULE_MOUSE_ENABLE
    #define MODULE_MOUSE_ENABLE        0
    #endif
    #ifndef MODULE_KEYBOARD_ENABLE
    ...
    #define MODULE_USB_ENABLE        1
    #endif
    #ifndef SYS_HOST_SUSPEND_MODE_ENABLE
    #define SYS_HOST_SUSPEND_MODE_ENABLE  0
    #endif
#else
	#ifndef MODULE_MOUSE_ENABLE
...
#define WATCHDOG_INIT_TIMEOUT		400		//  in ms
#endif
...
#endif
#ifndef IRQ_TIMER2_ENABLE
#define IRQ_TIMER2_ENABLE      0
#endif
#ifndef IRQ_PWM_TIMER
...
///////////////////  GPIO  //////////////////////////////
#if(MODULE_ETH_ENABLE)
#define    GPIO0_DATA_OUT            1            // do not reset at first, !! check ethernet-phy reset pin
#define R0_FUNC                    AS_ETH_MAC
#define R1_FUNC                    AS_ETH_MAC
#define T0_FUNC                    AS_ETH_MAC
#define T1_FUNC                    AS_ETH_MAC
#define TE_FUNC                    AS_ETH_MAC
#define MC_FUNC                    AS_ETH_MAC
#define MSC_FUNC                AS_ETH_MAC
#define MIO_FUNC                AS_ETH_MAC
#define MV_FUNC                    AS_ETH_MAC
#define ME_FUNC                    AS_ETH_MAC
#endif
...
#else
#define RF_PKT_BUFF_LEN            128            // 802.15.4 --- zigbee, rf4ce
#endif
...
#if(APPLICATION_DONGLE)
#define RF_WAIT_TOKEN_TIMEOUT			3000
#else
...
#define MOUSE_SCAN_INTERVAL				10000	// in us	

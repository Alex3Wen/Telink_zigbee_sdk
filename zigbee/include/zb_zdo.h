...
#define ZB_NWK_STATUS_CMD_TIME  ZB_MILLISECONDS_TO_BEACON_INTERVAL(0x2710)
...
#define zb_zdp_status_t zb_uint8_t
#endif
...
void zb_zdo_bind_unbind_req(zb_uint8_t param, zb_callback_t cb, zb_bool_t bind);
...
typedef struct zb_addr_conflict_s
{
	zb_uint8_t       entIndex;
	zb_uint16_t      nwk_addr;    /*!< NWK address for the Local Device  */
} ZB_PACKED_STRUCT zb_addr_conflict_t;
/**
...
/**
   ...
   @param dst_desc - source descriptor
*/
void zb_copy_simple_desc(zb_uint8_t * dst_desc, zb_af_simple_desc_t*src_desc) ;

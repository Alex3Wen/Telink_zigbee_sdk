...
#elif defined(ZB_TC32)


#ifdef ZB_TC32_TRACE
//#define TDEBUG(fmt, args) (printf("ZB-TDEBUG: "), printf (fmt, args), printf("\r\n "))
void zb_trace_msg_unix(char *format, char *file_name, int line_number, int args_size, ...);

#define _T0(...) __VA_ARGS__
#define _T1(l, fmts, args) if ((int)ZB_TRACE_LEVEL>=(int)l)  zb_trace_msg_unix(fmts, _T0 args)
#define TRACE_MSG(lm, fmts, args) _T1(lm, fmts, args)
...
//void zb_trace_msg_tc32(zb_char_t ZB_IAR_CODE *file_name, zb_int_t line_number, zb_uint8_t args_size, ...) ;
//#define _T1(s, l, args) if ((zb_int_t)ZB_TRACE_LEVEL>=(zb_int_t)l && ((s) & ZB_TRACE_MASK)) zb_trace_msg_tc32 args
//#define TRACE_MSG(lm, fmt, args) TDEBUG(fmt, args)

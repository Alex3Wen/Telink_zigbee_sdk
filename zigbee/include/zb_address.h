...
{                                                                       \
  ZB_MEMCPY(&((address)[0]),                                            \
            &(ZG->addr_record.dev_manufacturer[(compressed_address).dev_manufacturer].device_manufacturer[0]), \
            (sizeof((address)[0]) * 3));                                \
  ZB_MEMCPY(&((address)[3]), &((compressed_address).device_id[0]), (sizeof((address)[0]) * 5)); \
}                                                                       \
while (0)

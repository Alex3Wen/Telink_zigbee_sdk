...
typedef union zb_addr_u zb_addr_t;
...
#define ZB_HTOLE16(ptr, val)  					\
				do {              				\
					zb_uint8_t *_dst = (zb_uint8_t *)(ptr);    	\
					zb_uint8_t *_src = (zb_uint8_t *)(val);		\
					ZB_MEMCPY(_dst, _src, 2);		\
				} while (0)

#define ZB_HTOLE32(ptr, val)   					\
				do {              				\
					zb_uint8_t *_dst = (zb_uint8_t *)(ptr);    	\
					zb_uint8_t *_src = (zb_uint8_t *)(val);		\
					ZB_MEMCPY(_dst, _src, 4);		\
				} while (0)
#define ZB_HTOLE64(ptr, val)   					\
				do {              				\
					zb_uint8_t *_dst = (zb_uint8_t *)(ptr);    	\
					zb_uint8_t *_src = (zb_uint8_t *)(val);		\
					ZB_MEMCPY(_dst, _src, 8);		\
				} while (0)
#else

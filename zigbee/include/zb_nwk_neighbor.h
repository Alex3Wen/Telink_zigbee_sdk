...
#define ZB_NWK_NEIGHBOR_TABLE_SIZE()       (ZG->nwk.neighbor.base_neighbor_size)
/**
...
{                                                                       \
  ...
  {                                                                     \
    if ( ZG->nwk.neighbor.base_neighbor[_i].used                        \
         && (ZG->nwk.neighbor.base_neighbor[_i].outgoing_cost != 0)     \
...
zb_ushort_t zb_nwk_get_neighbor_table_size(zb_void_t);
/*! @} */
/*! \endcond */

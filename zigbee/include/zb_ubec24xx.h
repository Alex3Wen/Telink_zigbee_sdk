 ...
 */
#define ZB_TRANS_RECV_PACKET(buf) zb_5320_fifo_read(0, buf, 0)
#define ZB_TRANS_READ_TXNFIFO(buf, a)            \
  zb_5320_fifo_read(1, buf, a)
...
/**
   Read from FIFO
 */
void zb_5320_fifo_read(zb_uint8_t tx_fifo, zb_buf_t *buf, zb_uint8_t len) ZB_SDCC_REENTRANT;

...
#define rega_lost_conn_cnt      0x1a                // hisense spe
#define rega_pkt_seq_no			0x1b
#define rega_rf_dci				0x1c
#define rega_rf_dcq				0x1d
#define rega_deepsleep_rf_chn	0x1e
#define rega_deepsleep_flag		0x1f

#define rega_32k_tm_val0		0x20
#define rega_32k_tm_val1		0x21
#define rega_32k_tm_val2		0x22
#define rega_wakeup_src			0x23				// only valid for MCU 5328
...
#define rega_tx_pa_unit			0x9a

#define rega_tx_pa_ctrl			0x9b
enum{
	FLDA_PA_TX_BIAS = 			BIT_RNG(0,2),
	FLDA_PA_TX_DRV_BIAS = 		BIT_RNG(3,5),
	FLDA_PA_OFF_CURRENT = 		BIT(6),
	FLDA_PA_TX_EN = 			BIT(7),
};

#define rega_tx_pad_unit		0x9c

#define rega_rf_pll_setting1	0x9d
enum{
	FLDA_LOCKD_2X = 			BIT(0),
	FLDA_LOCKD_RST_N = 			BIT(1),
	FLDA_PFD_NP = 				BIT(2),
	FLDA_PFD_S0 =				BIT(3),
	FLDA_PFD_S1 = 				BIT(4),
	FLDA_CP_ENB = 				BIT(5),
	FLDA_CP_TRI_INTG = 			BIT(6),
	FLDA_LPF_VREF_HIGH = 		BIT(7),
};

#define rega_cp_ise1			0x9e

#define rega_dithering			0x9f
enum{
	FLDA_CP_ISE1_INTG = 		BIT_RNG(0,3),
	FLDA_DIT = 					BIT(4),
	FLDA_DIT_LSB = 				BIT_RNG(5,7),
};

...
static inline void gpio_init(void){
	...
	analog_write (0x08, PULL_WAKEUP_SRC_PWM0 |
						(PULL_WAKEUP_SRC_PWM1<<2) |
						(PULL_WAKEUP_SRC_PWM2<<4) |
						(PULL_WAKEUP_SRC_GPIO4<<6));

	analog_write (0x09,  PULL_WAKEUP_SRC_MSDO |
						(PULL_WAKEUP_SRC_MSDI<<2) |
						(PULL_WAKEUP_SRC_MCSN<<4) |
						(PULL_WAKEUP_SRC_MCLK<<6));

	analog_write (0x0c,  PULL_WAKEUP_SRC_GPIO0 |
						(PULL_WAKEUP_SRC_GPIO1<<2) |
						(PULL_WAKEUP_SRC_GPIO2<<4) |
						(PULL_WAKEUP_SRC_GPIO3<<6));

	analog_write (0x0d,  PULL_WAKEUP_SRC_CN |
						(PULL_WAKEUP_SRC_DI<<2) |
						(PULL_WAKEUP_SRC_DO<<4) |
						(PULL_WAKEUP_SRC_CK<<6));
...
static inline void gpio_mspi_float(void){
 	//analog_write (0x09, 0);
	analog_write (0x09, (PULL_WAKEUP_SRC_MCSN<<4) | (PULL_WAKEUP_SRC_MCLK<<6));
}

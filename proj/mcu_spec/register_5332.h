...
#define reg_mac_seq_no          0x19
#define reg_mac_channel         0x1a
#define reg_nwk_seq_no          0x1b
...
enum{
	...
	FLD_CLK_MCU_EN =			BIT(24),
	FLD_CLK_ZB_EN =				BIT(25),
	FLD_CLK_AES_EN =			BIT(26),
	FLD_CLK_DMA_EN =			BIT(27),
	FLD_CLK_ALGM_EN = 			BIT(28),
	FLD_CLK_SWIRE_EN = 			BIT(29),
	FLD_CLK_ADC_EN = 			BIT(30),
	FLD_CLK_USB_EN =			BIT(31),
...
enum{
	...
	FLD_CLK_SPWM_EN = 			BIT(4),
	FLD_CLK_SDM_EN =			BIT(5),
 ...
 *****************************************************/
#define reg_pwm0_setting1		REG_ADDR16(0xa0)
enum{
	FLD_PWM_CMP  = 				BIT_RNG(0,7),
	FLD_PWM_MAX  = 				BIT_RNG(8,15),
};
#define reg_pwm0_setting2		REG_ADDR8(0xa2)
enum{
...
#define reg_pwm0_en				REG_ADDR8(0xa3)
enum{
...
#define reg_pwm1_setting1		REG_ADDR16(0xa4)
#define reg_pwm1_setting2		REG_ADDR8(0xa6)
#define reg_pwm1_en				REG_ADDR8(0xa7)

/****************************************************
 SPWM regs struct: begin  addr : 0x5a5, 0x5a6, 0x80~0x8f
 *****************************************************/
#define reg_spwm_cfg1           REG_ADDR8(0x5a5)
enum {
	FLD_GPIO_AS_SPWM0 =         BIT(6),
	FLD_GPIO_AS_SPWM1 =         BIT(7),
};

#define reg_spwm_cfg2           REG_ADDR8(0x5a6)
enum {
	FLD_GPIO_AS_SPWM2 =         BIT(0),
};

#define reg_spwm_cc0            REG_ADDR8(0x80)
enum{
	FLD_SPWM0_EN = 	         	BIT(0),
	FLD_SPWM0_MODE = 			BIT(1),       // 0: continuing mode, 1: counting mode
	FLD_SPWM1_EN = 	         	BIT(2),
	FLD_SPWM1_MODE = 			BIT(3),       // 0: continuing mode, 1: counting mode
	FLD_SPWM2_EN = 	         	BIT(4),
	FLD_SPWM2_MODE = 			BIT(5),       // 0: continuing mode, 1: counting mode
	FLD_SPWM2_PTN = 	        BIT(6),       // 0: normal, 1: fixed pattern
	FLD_SPWM2_BITS = 			BIT(7),       // 0: fixed 8bits, 1: fixed 16bits
};

#define reg_spwm_cc1            REG_ADDR8(0x81)
enum{
	FLD_SPWM_FREQ_SEL  = 		BIT_RNG(0,2),
	FLD_SPWM0_INVERT_OUTPUT = 	BIT(4),
	FLD_SPWM1_INVERT_OUTPUT = 	BIT(5),
	FLD_SPWM2_INVERT_OUTPUT = 	BIT(6),
};

#define reg_spwm0_t00           REG_ADDR8(0x84)
#define reg_spwm1_t10           REG_ADDR8(0x88)
#define reg_spwm2_t20           REG_ADDR8(0x8c)
enum{
	FLD_SPWM_HIGH_TIME_7_0  = 	BIT_RNG(0,7),
};

#define reg_spwm0_t01           REG_ADDR8(0x85)
#define reg_spwm1_t11           REG_ADDR8(0x89)
#define reg_spwm2_t21           REG_ADDR8(0x8d)
enum{
	FLD_SPWM_HIGH_TIME_10_8  = 	BIT_RNG(0,2),
	FLD_SPWM_LOW_TIME_4_0  = 	BIT_RNG(3,7),
};

#define reg_spwm0_t02           REG_ADDR8(0x86)
#define reg_spwm1_t12           REG_ADDR8(0x8a)
#define reg_spwm2_t22           REG_ADDR8(0x8e)
enum{
	FLD_SPWM_LOW_TIME_10_5  = 	BIT_RNG(0,5),
	FLD_SPWM_PHASE_TIME_1_0  = 	BIT_RNG(6,7),
};

#define reg_spwm0_t03           REG_ADDR8(0x87)
#define reg_spwm1_t13           REG_ADDR8(0x8b)
#define reg_spwm2_t23           REG_ADDR8(0x8f)
enum{
	FLD_SPWM_PHASE_TIME_9_2  = 	BIT_RNG(0,7),
};

#define reg_spwm_t0(ch)         REG_ADDR8(0x84+ch*4)
#define reg_spwm_t1(ch)         REG_ADDR8(0x85+ch*4)
#define reg_spwm_t2(ch)         REG_ADDR8(0x86+ch*4)
#define reg_spwm_t3(ch)         REG_ADDR8(0x87+ch*4)
 ...
 *****************************************************/
#define reg_gpio_f_datai		REG_ADDR32(0x5a8)
#define reg_gpio_f_datao		REG_ADDR32(0x580)
#define reg_gpio_f_oe			REG_ADDR32(0x584)
#define reg_gpio_f_nrm			REG_ADDR32(0x5a4)
enum{
	FLD_MSDO_FUNC = 			BIT(0),
	FLD_CN_FUNC = 				BIT(1),
	FLD_CK_FUNC =				BIT(2),
	FLD_DO_GPIO_FUNC =			BIT(3),
	FLD_DI_FUNC =				BIT(4),
	FLD_PWM0_FUNC =				BIT_RNG(5,6),
	FLD_PWM1_FUNC = 			BIT_RNG(7,8),
	FLD_PWM2_FUNC = 			BIT(9),
	FLD_SWS_FUNC = 				BIT_RNG(10,12),
	FLD_SWM_FUNC =				BIT_RNG(13,15),
	FLD_DO_PWM_FUNC =			BIT(16),
	FLD_DP_FUNC =				BIT(22),
};

#define reg_gpio_f_ie			REG_ADDR32(0x588)
#define reg_gpio_f_pol			REG_ADDR32(0x590)
#define reg_gpio_f_ds			REG_ADDR32(0x58c)
#define reg_gpio_f_wakeup_en	REG_ADDR32(0x594)
#define reg_gpio_f_2risc0		REG_ADDR32(0x598)
#define reg_gpio_f_2risc1		REG_ADDR32(0x59c)
#define reg_gpio_f_2risc2		REG_ADDR32(0x5a0)
#define reg_gpio_g_datao		REG_ADDR32(0x5b0)
#define reg_gpio_g_oe			REG_ADDR32(0x5b4)
#define reg_gpio_g_ie			REG_ADDR32(0x5b8)
#define reg_gpio_g_ds			REG_ADDR32(0x5bc)
#define reg_gpio_g_wakeup_en	REG_ADDR32(0x5c4)
...
#define reg_gpio_g_2risc0		REG_ADDR32(0x5c8)
#define reg_gpio_g_2risc1		REG_ADDR32(0x5cc)
#define reg_gpio_g_2risc2		REG_ADDR32(0x5d0)
#define reg_gpio_g_pol			REG_ADDR32(0x5c0)
#define reg_gpio_g_datai		REG_ADDR32(0x5ac)

...
#else
#define write_reg8(addr,v)	U8_SET(addr,v)
#define write_reg16(addr,v)	U16_SET(addr,v)
#define write_reg32(addr,v)	U32_SET(addr,v)
#define read_reg8(addr)		U8_GET(addr)
#define read_reg16(addr)	U16_GET(addr)
#define read_reg32(addr)	U32_GET(addr)
#endif
